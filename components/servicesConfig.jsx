...
export const previewServices = [
  { title: 'General Dentistry', description: 'Comprehensive dental care for the whole family', icon: <DentalIcon />, href: '/services/general-dentistry' },
...
export const allServices = [
  ...
  { title: 'Periodontics', description: 'Treatment for gum disease and gum health maintenance', icon: <DentalIcon />, href: '/services/periodontics' },
]
